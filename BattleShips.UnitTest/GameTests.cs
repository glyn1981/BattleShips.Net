...
namespace BattleShips.UnitTest
{
    public class GameTests
    {
        ...
        public void TestGameLogic()
        {
            ...
            Game gameObject = new Game(shipList, new List<string>(), new Random(), new InputValidator(), new Utils(),new InputHandler(), new ShipStrikeChecker(), new ShipInitialiser(), new BoardInitialiser(), new GameDisplay());
